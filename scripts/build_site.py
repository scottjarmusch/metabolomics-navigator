...
def static_pages(repository_url,url):
    about='''<h2>An open scientific reference</h2><p>Metabolomics Navigator helps researchers find tools and transferable analytical strategies for MS-based metabolomics. Entries bring together documented capabilities, required inputs, practical limitations and core publications.</p><h2>Project authors</h2><p><strong>Scott A. Jarmusch</strong> and <strong>Alan K. Jarmusch</strong> co-designed and implemented Metabolomics Navigator.</p><ul><li><a href="https://orbit.dtu.dk/en/persons/scott-alexander-jarmusch/">Scott A. Jarmusch — DTU profile</a></li><li><a href="https://www.niehs.nih.gov/research/atniehs/facilities/nih-metabolomics-consortium/profiles">Alan K. Jarmusch — NIEHS profile</a></li></ul><p>Institutional affiliations are provided for identification only and do not imply endorsement by DTU, NIEHS or NIH.</p><h2>Built with the community</h2><p>Researchers can suggest resources, correct entries and propose analytical strategies. Contributions are reviewed before publication and openly versioned on GitHub. Developer or author verification is recorded separately from editorial review.</p><h2>Editorial scope</h2><p>The catalogue covers MS-based metabolomics. Tool pages describe reusable resources; Analytical Strategies describe transferable methodological contributions. Ordinary application studies do not qualify solely because they use metabolomics. Inclusion is not endorsement, benchmarking or a performance ranking.</p>'''
