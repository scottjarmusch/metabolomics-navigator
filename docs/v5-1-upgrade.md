# v5.1 visual refinement

v5.1 is a focused usability and scale refinement of the v5 design. It does not change the catalogue schema, submission forms, or GitHub Actions workflows.
...
5. Commit directly to `main` with the message `Apply v5.1 visual refinements`.
6. Do not manually trigger workflows. Wait for catalogue validation and GitHub Pages deployment to complete automatically.
7. Hard-refresh the live site if the old CSS is temporarily cached.

No `.github` update is needed.
